...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.action_add_style = QAction(MainWindow)
        self.action_add_style.setObjectName(u"action_add_style")
        self.action_delete_style = QAction(MainWindow)
        self.action_delete_style.setObjectName(u"action_delete_style")
...
"}")
        ...
        self.menu_format.addSeparator()
        self.menu_format.addAction(self.action_add_style)
        self.menu_format.addAction(self.action_delete_style)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_add_style.setText(QCoreApplication.translate("MainWindow", u"Add style", None))
        self.action_delete_style.setText(QCoreApplication.translate("MainWindow", u"Delete style", None))
